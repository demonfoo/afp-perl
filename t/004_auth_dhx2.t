...
# just pretend to be enough of Net::AFP to test this UAM
{
    ...
    sub new {
        ...
        %{$obj} = (
            ...
            p         => q{},
            g         => 5,
    ...
    sub dhx2_part1 {
        ...
        my $Mb = Net::AFP::UAMs::zeropad(
          ${$obj}{$pfx . q{dh}}->export_key_raw(q{public}), ${$obj}{len});
    ...
    sub dhx2_part2 {
        ...
        my($Ma, $ciphertext) =
          unpack sprintf(q{a[%d]a[%d]}, ${$obj}{len},
          ${$obj}{nonce_len}), $message;
        printf qq{client pubkey is %s\n}, unpack q{H*}, $Ma;

        ${$obj}{$pfx . q{K}} = Net::AFP::UAMs::zeropad(
          Crypt::Digest::MD5::md5(Net::AFP::UAMs::zeropad(
          ${$obj}{$pfx . q{dh}}->shared_secret(Crypt::PK::DH->new()
          ->import_key_raw($Ma, q{public},
          { p => ${$obj}{p}, g => ${$obj}{g}})), ${$obj}{len})), 16);
        ...
        ${$obj}{$pfx . q{cli_nonce}} = Net::AFP::UAMs::zeropad(
          ${$obj}{$pfx . q{ctx}}->decrypt($ciphertext,
          @{$obj}{$pfx . q{K}, q{C2SIV}}), ${$obj}{nonce_len});
        ...
        $ciphertext = ${$obj}{$pfx . q{ctx}}->encrypt(
          pack(sprintf(q{a[%1$d]a[%1$d]}, ${$obj}{nonce_len}),
          Net::AFP::UAMs::zeropad(
          Crypt::Misc::increment_octets_be(${$obj}{$pfx . q{cli_nonce}}),
          ${$obj}{nonce_len}),
          Net::AFP::UAMs::zeropad(${$obj}{$pfx . q{srv_nonce}},
          ${$obj}{nonce_len})), @{$obj}{$pfx . q{K}, q{S2CIV}});
    ...
    sub dhx2_part3 {
        ...
        if (Net::AFP::UAMs::zeropad(
          Crypt::Misc::increment_octets_be(${$obj}{$pfx . q{srv_nonce}}),
          ${$obj}{nonce_len}) ne $nonce) {
            return $Net::AFP::Result::kFPParamErr;
        }
    ...
    sub FPLoginCont {
        ...
        if (exists ${$obj}{id} and $id == ${$obj}{id}) {
            ...
            my($rc, $pw) = dhx2_part3($obj,
              sprintf(q{Z[%d]}, ${$obj}{pw_len}), $ai);
            delete ${$obj}{id};
    ...
    sub FPChangePassword {
        ...
        if ($id == ${$obj}{pc_id}) {
            ...
            my($rc, $n, $o) = dhx2_part3($obj,
              sprintf(q{Z[%1$d]Z[%1$d]}, ${$obj}{pw_len}), $the_rest, q{pc_});
            delete ${$obj}{pc_id};
            if ($rc != $Net::AFP::Result::kFPNoErr) {
                return $rc;
            }

...
use constant kRecon1Login           => 5;   # AFP 3.1+ (10.3)
use constant kRecon1ReconnectLogin  => 6;   # AFP 3.1+ (10.3)
use constant kRecon1Refresh         => 7;   # AFP 3.1+ (10.3)
use constant kGetKerberosSessionKey => 8;   # AFP 3.1+ (10.3)

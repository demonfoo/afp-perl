...
Readonly our $kSupportsBlankAccessPrivs => 0x0010;  # AFP 2.1
Readonly our $kSupportsUnixPrivs        => 0x0020;  # AFP 3.0
Readonly our $kSupportsUTF8Names        => 0x0040;  # AFP 3.0
Readonly our $kNoNetworkUserIDs         => 0x0080;  # AFP 3.1
Readonly our $kDefaultPrivsFromParent   => 0x0100;  # AFP 3.1+ (10.3)
Readonly our $kNoExchangeFiles          => 0x0200;  # AFP 3.2
Readonly our $kSupportsExtAttrs         => 0x0400;  # AFP 3.2
Readonly our $kSupportsACLs             => 0x0800;  # AFP 3.2
Readonly our $kCaseSensitive            => 0x1000;  # AFP 3.2+ (10.5)
Readonly our $kSupportsTMLockSteal      => 0x2000;  # AFP 3.2+ (10.5)
